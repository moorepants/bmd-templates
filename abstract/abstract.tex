...
% affiliation name, and EmailOrcidString is a string listing emails and 
% ORCIDs (optional) affiliated with this affiliation separating mail and 
% ORCID using a comma and different author credentials using a semicolon.

\addaffiliation{1}{Department of Engineering, University of Technology, Netherlands}{a.b.one@uot.nl, ORCID 1111-1111-1111-1111}
\addaffiliation{2}{Department of Engineering, University of Technology, Netherlands}{a.c.two@uot.nl, ORCID 2222-2222-2222-2222; 
	a.d.three@uot.nl, ORCID 3333-3333-3333-3333}
...
for abstracts. For LaTeX documents, upload a single ZIP file that includes the
...
New Roman, and the primary text should be written in Times New Roman, 10~pt.
All these fonts are already set and should not be edited.
...
be centered on the page. Use of at least 300 ppi resolution for pictures and
...
citations. If using a \verb|.bib| file, use the \verb|apacite| bibliography
