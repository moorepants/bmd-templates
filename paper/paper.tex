...
the ZIP file directory tree or under the only top level directory, e.g.
\verb|paper/paper.tex|. Avoid using LaTeX packages other than those listed in
the \verb|bmd2023p.cls| file for compatibility with Orvium.
...
Roman 18~pt, and may extend over more than one line. The author's name or
authors' names should be in Times New Roman 10~pt and the affiliation should be
in 8~pt. Section headings are in Times New Roman 11~pt and the primary text is in
Times New Roman 10~pt. All of these fonts are already set and should not be
edited. Only use \verb|\section| and \verb|\subsection| for sectioning the
paper's contents.
...
be centered on the page. Use of at least 300~dpi resolution for images and
