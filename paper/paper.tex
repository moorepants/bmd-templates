...
Please upload your finished manuscript as .odt, .docx. or zipped LaTeX project.
PDFs will not be accepted. For LaTeX documents, upload a single ZIP file that
includes the minimum set of source files needed to build a PDF. The ZIP file
should be named using the following pattern
