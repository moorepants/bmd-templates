...
and figures) to the Orvium web site by the stated date in the call for
abstracts. For LaTeX documents, upload a single ZIP file that includes the
...
primary LaTeX file should be named \verb|paper.tex|. Avoid using LaTeX packages
other than those listed in the \verb|bmd2023p.cls| file for compatibility with
Orvium.
...
The abstract has the section heading \textbf{Abstract:}, bold 11~pt Times New
Roman, and the primary text should be written in Times New Roman, 10~pt. All
these fonts are already set and should not be edited.
