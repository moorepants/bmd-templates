...
following pattern \verb|Surname1Surname2Surname3_paper.zip|. The primary LaTeX
file should be named \verb|paper.tex| and should reside in the root of the ZIP
file directory tree or under the only top level directory, e.g.
\verb|paper/paper.tex|. Orvium compatible LaTeX packages are listed in the
\verb|bmd2023p.cls| file; use of other packages may not function with Orvium.
